...
public class sachthieunhi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sachthieunhi);
        recyclerView=findViewById(R.id.rcv_sachthieunhi);
        list = new ArrayList<>();
        GetListBook();
    ...
    private void GetListBook() {
        ...
        ref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if(book_demo!=null){
                    if(book_demo.getType().contains("sachthieunhi"))
                    {
                        list.add(book_demo);
                    }
                }
